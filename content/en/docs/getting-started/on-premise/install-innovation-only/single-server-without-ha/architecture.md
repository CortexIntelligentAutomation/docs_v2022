...
| Cortex&nbsp;Block&nbsp;Packages | A set of files which contain the blocks that users can use to build flows. Used by the Cortex Flow Debugger Service and the Cortex Execution Service. | Required | Web&nbsp;Application&nbsp;Server, Application&nbsp;Server |
