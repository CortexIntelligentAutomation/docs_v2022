...
The 2022.9 Release is now generally available.

## Download Artefacts

Installation artefacts can be downloaded from our [Cortex Innovation GitHub repository][TODO: Link to download location].
...
General overview using outcomes
...
- Review this
- Add links to guides, guides should contain info on purpose and relevant docs

| Component              | Version         | Updated This Release | Update Type | Notes           |
|------------------------|-----------------|----------------------|-------------|-----------------|
| API Gateway Service    | 2.0.0           | Yes                  | Major       | New Feature     |
| Flow Debugger Service  | 1.0.1           | Yes                  | Major       | New Feature     |
| Flow Execution Service | 1.0.0           | Yes                  | Major       | New Feature     |
| Gateway                | 3.1.0           | Yes                  | Minor       | New Feature     |
| [Blocks][]             | 29.2.0          | Yes                  | Major       | New Feature     |
...
A new engine has been created for the Innovation Platform...
...
- Publish a package version
  - Implicitly sets default package version
- Explicitly set your own default package version
- Unpublish package version
- Import/Export a package version
...
[Adding Innovation to a 7.2 Installation - Single Server - Without HA]: {{< url "Cortex.Reference.Concepts.Fundamentals.Executions.ExecutionsInProduction.MainDoc" >}}
[Adding Innovation to a 7.2 Installation - Multiple Server - With HA]: {{< url "Cortex.Reference.Concepts.Fundamentals.Executions.ExecutionsInProduction.MainDoc" >}}
